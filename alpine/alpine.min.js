(() => {
    ...
    var ut = new MutationObserver(mt),
        ft = !1;
    function le() {
        ut.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }),
            (ft = !0);
    }
    function dt() {
...
`
    ...
    d('transition', (e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
        typeof n == 'function' && (n = i(n)),
            n !== !1 && (!n || typeof n == 'boolean' ? Kn(e, r, t) : zn(e, n, t));
    });
    function zn(e, t, r) {
        Er(e, me, ''),
            {
    ...
    function zi(e, t) {
        let r = t.filter(
            (o) => !['window', 'document', 'prevent', 'stop', 'once', 'capture'].includes(o)
        );
    ...
    function Wi(e, t, r, n) {
        ...
        r((s) => {
            ...
            for (let f = 0; f < w.length; f++) {
                let g = w[f];
                a[g]._x_effects && a[g]._x_effects.forEach(ve),
                    a[g].remove(),
                    (a[g] = null),
                    delete a[g];
            }
            ...
            for (let f = 0; f < p.length; f++) {
                ...
                P(ae, Ht, o),
                    ...
                    typeof Z == 'object' &&
                        v('x-for key cannot be an object, it must be a string or an integer', o),
                    (a[Z] = ae);
            }
